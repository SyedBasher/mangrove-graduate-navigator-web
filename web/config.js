export const SUPABASE_URL = 'https://hdftqqhrsvespkdhunlr.supabase.co';
export const SUPABASE_PUBLISHABLE_KEY = 'sb_publishable_oB1kSTlZvcA1kZTgbgFuGA_adMmgyVl';
export const ASSESSMENT_VERSION = '0.5.4';
export const CONSENT_VERSION = '0.3.0';
